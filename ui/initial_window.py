...
class Ui_InitialWindow(object):
    def setupUi(self, InitialWindow):
        ...
        self.bettaInitialField.setMaximumSize(QtCore.QSize(15005, 30))
        self.bettaInitialField.setInputMethodHints(QtCore.Qt.ImhFormattedNumbersOnly)
        self.bettaInitialField.setTabChangesFocus(True)
        ...
        self.xInitialField.setMaximumSize(QtCore.QSize(16777215, 30))
        self.xInitialField.setInputMethodHints(QtCore.Qt.ImhFormattedNumbersOnly)
        self.xInitialField.setTabChangesFocus(True)
        ...
        self.yInitialField.setMaximumSize(QtCore.QSize(16777215, 30))
        self.yInitialField.setInputMethodHints(QtCore.Qt.ImhFormattedNumbersOnly)
        self.yInitialField.setTabChangesFocus(True)
        ...
        self.tInitialField = QtWidgets.QPlainTextEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tInitialField.sizePolicy().hasHeightForWidth())
        self.tInitialField.setSizePolicy(sizePolicy)
        self.tInitialField.setMaximumSize(QtCore.QSize(16777215, 30))
        self.tInitialField.setInputMethodHints(QtCore.Qt.ImhFormattedNumbersOnly)
        self.tInitialField.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.tInitialField.setFrameShadow(QtWidgets.QFrame.Raised)
        self.tInitialField.setTabChangesFocus(True)
    ...
    def retranslateUi(self, InitialWindow):
        ...
        self.bettaInitialField.setPlainText(_translate("InitialWindow", "0.0"))
        self.xInitialLabel.setText(_translate("InitialWindow", "X0"))
        self.xInitialField.setPlainText(_translate("InitialWindow", "0.0"))
        self.yInitialLabel.setText(_translate("InitialWindow", "Y0"))
        self.yInitialField.setPlainText(_translate("InitialWindow", "0.0"))
        self.label_3.setText(_translate("InitialWindow", "T"))
        self.tInitialField.setPlainText(_translate("InitialWindow", "10.0"))
